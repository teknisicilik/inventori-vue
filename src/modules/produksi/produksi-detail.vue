...
export default {
  ...
  data () {
    return {
      config: {
        ...
        model_api: "produksi-detail",
        getter: "produksi-detail",
        setter: "produksi-detail",
        // pk_field: 'area_name',
        permission: {
          create: false,
  ...
  methods: {
    async getValid () {
      ...
      let detail = await this.$_api.dataset('produksi-detail', {limit: 10, produksi_id: this.$store.state.activeSlave.key}).then(res => { return res.data })
